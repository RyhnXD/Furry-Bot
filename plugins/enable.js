...
📣 *For:* ${isAll ? 'This Bot' : isUser ? '' : 'This Chats'}`, wm, `⋮☰ Menu`, '.menu', `${isEnable ? 'Off' : 'On'} ${type}`, `.${isEnable ? 'Off' : 'On'} ${type}` ,{ key: { fromMe: false, remoteJid: 'status@broadcast', participant: '0@s.whatsapp.net' }, message: { orderMessage: { message: `🍒 Cherry`, itemCount: 99999, thumbnail: await (await fetch('https://telegra.ph/file/09f6fd389fef97938b40b.jpg')).buffer(),}}})
}
